...
///   ```
#[pyfunction]
#[pyo3(name = "cdl_dragonfly_doji_incremental", signature = (open, high, low, close, body_percent))]
pub fn cdl_dragonfly_doji_incremental_py(
    py: Python,
    open: TAFloat,
    high: TAFloat,
    low: TAFloat,
    ...
    py.allow_threads(|| {
        cdl_dragonfly_doji::cdl_dragonfly_doji_incremental(open, high, low, close, body_percent)
    })
    .map_err(|e| PyErr::new::<pyo3::exceptions::PyValueError, _>(e.to_string()))
}
